...
export interface AnalyticsConfig {
  /** Total return claims count */
  totalReturnClaims: number;
  /** Revenue saved (in dollars) */
  revenueSaved: number;
  /** Return rate as percentage */
  returnRate: number;
  /** Claims over time data points */
...
export function createDefaultDemoConfig(overrides?: Partial<DemoConfig>): DemoConfig {
  ...
  return {
    ...
    admin: {
      ...
      analytics: {
        totalReturnClaims: 1247,
        revenueSaved: 45230.50,
        returnRate: 3.2,
        claimsOverTime: [
          { date: '2024-01-01', claims: 45 },
          { date: '2024-01-08', claims: 52 },
          { date: '2024-01-15', claims: 38 },
          { date: '2024-01-22', claims: 61 },
          { date: '2024-01-29', claims: 55 },
          { date: '2024-02-05', claims: 48 },
          { date: '2024-02-12', claims: 67 },
        ],
        recentClaims: [
          {
            id: '1',
            orderNumber: '3183',
            customerName: 'Carl Smiles',
            amount: '$349.00',
            status: 'pending',
